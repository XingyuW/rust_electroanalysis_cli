...
| <a id="F-IMPL-007"></a>`F-IMPL-007` | `F-ARCH-010,F-ARCH-021,F-ARCH-022` | Integration validation parses the authoritative R12 artifact graph, derives the mandatory G3 prerequisite closure, proves each downstream artifact binds its exact upstream authority, validates migrated-review lifecycle/staleness and aggregate closure, and rejects self-Git/future-object/hash cycles or implementation-readiness bypasses. | §§17–19, R12 authority graph and conformance §3.2 |
