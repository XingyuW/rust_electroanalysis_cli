...
| R12-DAG-BINDING-EQUALITY | constructive_plan_audit | r12_artifact_authority_graph | independently derived binding/prerequisite projections, serialized mirror, builder fields, or validator fields are incomplete, extra, or no longer equal to the exact node-level edge contract | graph/object mutation matrix | R12 graph projection and G3 authority audit | REJECT | exact graph/binding/prerequisite equality mismatch | 0 |
