...
equality for 22 nodes and 27 edges, including the canonical GitHub repository
identity, authenticated immutable ruleset protection evidence, the published
normative target, protected external monotonic head, signed subject-registry
