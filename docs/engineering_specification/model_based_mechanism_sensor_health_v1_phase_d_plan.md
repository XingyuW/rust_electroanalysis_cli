...
checksum, including `N-X05`, reader, schema, identity, provenance,
Phase-C/evidence invariant, all bundle scope decisions including the scale
bundle, and the expected rejection of `N-F13,N-F14,N-X01`–`N-X05`.
